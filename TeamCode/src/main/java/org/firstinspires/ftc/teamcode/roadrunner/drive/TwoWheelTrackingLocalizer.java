...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PERPENDICULAR_X = -9.0;
    public static double PERPENDICULAR_Y = -0.375;

    public static double X_MULTIPLIER = 0.99488; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.99488; // Multiplier in the Y direction
