package org.firstinspires.ftc.teamcode.archive.library.dronelauncher;
...
import org.firstinspires.ftc.teamcode.library.rotator.RotatorMoveToPositionCommand;
...
public class DroneLauncher extends Component {
    ...
    public DroneLauncher rotateToPosition (double position, double power) {
        this.addCommand(new RotatorMoveToPositionCommand(this.rotator, position, power));
        return this;
    }
