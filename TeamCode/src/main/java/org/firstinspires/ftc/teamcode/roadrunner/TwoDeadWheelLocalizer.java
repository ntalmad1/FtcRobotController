...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1610.8881853491143; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2346.008207714719; // x position of the perpendicular encoder (in tick units)
    }
